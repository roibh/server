...
module.exports = ".value-label {\n  position: absolute; }\n\n.consolelog {\n  position: absolute;\n  top: 150px;\n  left: 150px;\n  background-color: black;\n  color: white;\n  width: 200px;\n  height: 200px;\n  font-size: 10px; }\n\n.drag-block {\n  min-width: 50px;\n  position: absolute; }\n\n.drag-block .image-rotate {\n    background-color: black;\n    height: 10px;\n    width: 10px;\n    position: absolute;\n    top: 20px;\n    cursor: e-resize; }\n\n.drag-block .drag-tag {\n    opacity: 0;\n    position: absolute;\n    top: -20px;\n    background-color: #f3b7eb;\n    text-transform: capitalize;\n    height: 20px;\n    background-color: #f3b7eb;\n    left: -2px;\n    min-width: 100px;\n    color: white;\n    padding: 3px;\n    padding-left: 25px; }\n\n.drag-block span {\n    cursor: text;\n    display: inline; }\n\n.element-container {\n  position: relative; }\n\n.element {\n  white-space: nowrap;\n  line-height: 1;\n  border: 1px solid transparent;\n  line-break: loose; }\n\n.element .del-button {\n    opacity: 0; }\n\n.element .selected, .element .true {\n    border: 1px solid black; }\n\n.side {\n  width: 10px;\n  height: 10px;\n  background-color: #a599a3;\n  position: absolute; }\n\n.side-l {\n  top: 45%;\n  left: -10px;\n  cursor: ew-resize; }\n\n.side-t {\n  top: -10px;\n  left: 45%;\n  cursor: ns-resize; }\n\n.side-r {\n  top: 45%;\n  right: -10px;\n  cursor: ew-resize; }\n\n.side-b {\n  left: 45%;\n  bottom: -10px;\n  cursor: ns-resize; }\n\n.nomouse {\n  pointer-events: none; }\n\n.corner {\n  width: 10px;\n  height: 10px;\n  background-color: #a599a3;\n  border-radius: 30px;\n  position: absolute;\n  z-index: 999; }\n\n.corner-pad {\n  position: absolute;\n  top: -20px;\n  left: -20px;\n  bottom: -20px;\n  right: -20px;\n  z-index: 1000; }\n\n.corner-lt {\n  top: -10px;\n  left: -10px; }\n\n.corner-rt {\n  top: -10px;\n  right: -10px;\n  cursor: sw-resize; }\n\n.corner-lb {\n  bottom: -10px;\n  left: -10px;\n  cursor: sw-resize; }\n\n.corner-rb {\n  bottom: -10px;\n  right: -10px;\n  cursor: nw-resize; }\n\n.selected .drag-tag, .true .drag-tag {\n  opacity: 1;\n  cursor: move; }\n\n.selected .del-button, .true .del-button {\n  opacity: 1;\n  position: absolute;\n  left: 0px;\n  top: 0px;\n  width: 20px;\n  height: 20px;\n  color: white;\n  cursor: pointer; }\n\n.del-button:active,\n.del-button:hover {\n  opacity: 1; }\n\n.form-control {\n  height: 15px; }\n\n.position {\n  position: absolute; }\n\n.t-bar {\n  position: absolute;\n  font-size: 9px; }\n\n.t-bar input {\n    width: 50px; }\n\n.t-bar select {\n    width: 100px; }\n\n.position {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 100px;\n  font-size: 9px; }\n\n.layer {\n  height: 130px;\n  background-color: white; }\n\n.layer .toolbox select, .layer .toolbox input {\n    font-size: 10px; }\n\n.layer .toolbox input {\n    width: 30px; }\n\n.layer .toolbox img {\n    float: right;\n    width: 50px;\n    height: 50px; }\n\n.layer .toolbox.active {\n    display: block; }\n\n.value-input {\n  border: none;\n  width: 50px;\n  height: 20px;\n  color: white;\n  padding: 2px;\n  background-color: black;\n  border-radius: 50px; }\n\n.rotate {\n  cursor: url(\"/assets/editor/cursors/rotate.webp\"), pointer;\n  position: absolute;\n  bottom: -60px;\n  left: 48%;\n  background: none;\n  border: none; }\n\n.hilight {\n  border: 1px dashed #689f59; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ElementComponent = /** @class */ (function () {
    ...
    ElementComponent.prototype.hilight = function (state, ev) {
        if (state) {
            ev.currentTarget.className = ev.currentTarget.className + '  hilight';
        }
        else {
            ev.currentTarget.className = ev.currentTarget.className.replace('hilight', '');
        }
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
