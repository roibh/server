...
export class DataController {
    ...
    public static async create(@Body('record') record: any) {
        const repo = (this as any).methodus.repository;
    ...
    public static async update(@Param('id') id: string, @Body('record') record: any) {
        const repo = (this as any).methodus.repository;
    ...
    public static async query(@Body('query') queryObject: any) {
        const repo = (this as any).methodus.repository;
